            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center sec-title">
                        <h2 class="h2-title"><?php the_field('request_a_quote_title'); ?></h2>
                        <p><?php the_field('request_a_quote_sub_title'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="news-content text-center">
                            <h2 class="h2-title"><?php the_field('news_letter_title'); ?></h2>
                            <p><?php the_field('news_letter_sub_title'); ?></p>
                            <div class="news-form">
